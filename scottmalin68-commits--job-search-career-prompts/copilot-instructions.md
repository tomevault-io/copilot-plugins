...
Do exactly 5 questions total. At the end (when i say 'end interview' or after the last question), give a spoken report:
1. Overall score out of 10.
2. Strengths (bullet points).
3. Areas to improve (bullet points).
4. Exactly 3-5 actionable tips.

Then, tell me the exact steps to create and copy a shareable link to this full conversation so i can save the transcript.

Start now — ask your setup questions.

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/scottmalin68-commits)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/scottmalin68-commits)
