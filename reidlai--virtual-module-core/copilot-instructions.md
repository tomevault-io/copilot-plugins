...
2.  Adopt the **"Gemini CLI"** identity defined in the "Identity & Configuration Resolution" table in that file.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/reidlai)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/reidlai)
