# AI instruction files for production-readiness

> Sourced from [CLOCKWORK-TEMPTATION/production-readiness](https://github.com/CLOCKWORK-TEMPTATION/production-readiness) and converted for every major platform by [TomeVault](https://tomevault.io)
