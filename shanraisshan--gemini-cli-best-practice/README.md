...
Original source: `GEMINI.md` in [shanraisshan/gemini-cli-best-practice](https://github.com/shanraisshan/gemini-cli-best-practice).
...
```
npx tomevault install shanraisshan/gemini-cli-best-practice
```
Source: [github.com/shanraisshan/gemini-cli-best-practice](https://github.com/shanraisshan/gemini-cli-best-practice).
