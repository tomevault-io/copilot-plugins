...
> Evaluate and score articles, speeches, books (by chapter), etc for alignment against a High Law vs Low Law framework
...
| **{{TOPIC_N}}** | - {{HL_POINT_N_1}}<br>- {{HL_POINT_N_N}} | - {{LL_POINT_N_1}}<br>- {{LL_POINT_N_N}} |
...
---
> Source: [jonesde/high-vs-low](https://github.com/jonesde/high-vs-low) — distributed by [TomeVault](https://tomevault.io).
