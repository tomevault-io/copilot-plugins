...
- **What is the nature of this problem?** — Is it an investment decision, trend forecast, institutional assessment, or people/team evaluation? Different types call for different lens combinations. `→ Meta-Model`
- **What is my initial hypothesis?** — State your implicit assumptions explicitly. Unstated assumptions are the most dangerous — you'll unconsciously seek only confirming evidence. `→ Falsifiability`
- **What evidence would prove me wrong?** — If you can't find falsification conditions, your hypothesis may be a belief, not a hypothesis. `→ Falsifiability`
- **What stage is this economy/industry/company at?** — Agricultural → Industrial → Knowledge economy. Different stages need different frameworks. `→ Material Foundations`
- **What is the prevailing narrative?** — Tag the narrative environment before you start analyzing, so you can check later whether the narrative distorted your judgment. `→ Narrative & Reality`
...
- [ ] **Do I truly understand this domain?** How does my understanding compare to industry experts?
- [ ] **Can I identify the key variables?** If you can't name the top 3 factors that determine the outcome, you're outside your circle.
...
- [ ] For investments: How much discount does the current price offer vs your estimated intrinsic value?
- [ ] For business decisions: What's the worst-case loss? Can you survive it?
- [ ] For life decisions: If the most optimistic assumption doesn't materialize, is what's left still worth it?
...
- [ ] Strip away the story, look at numbers only — does the conclusion still hold?
- [ ] Is reflexivity at work — is the narrative itself creating or distorting reality?
- [ ] Is everyone saying the same thing? If so, check for crowd madness.
...
- [ ] What's the long-term trend? Are short-term fluctuations creating long-term opportunities?
- [ ] Do you have the patience and resources to wait?
- [ ] Compounding: If the direction is right, is time your friend or enemy?
...
- [ ] **Macro level**: What's the institutional quality of this market/country? Rule of law, property rights, information transparency?
- [ ] **Micro level**: How healthy is the governance structure of this company/organization? Management-board-shareholder dynamics?
- [ ] **Do institutional flaws pose hidden risks?** Strong economic numbers don't guarantee institutional reliability.
...
- [ ] Set explicit test criteria: What evidence would prove you wrong?
- [ ] Under what conditions should you change your mind? Write it down now, don't wait for reality to force you.
- [ ] Schedule regular reviews: Does your hypothesis still hold? Has the environment changed?
...
---
> Source: [EdLuxAI/li-lu-worldly-wisdom](https://github.com/EdLuxAI/li-lu-worldly-wisdom) — distributed by [TomeVault](https://tomevault.io).
