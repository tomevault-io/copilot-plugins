...
Run: `organvm ecosystem show adaptive-personal-syllabus` | `organvm ecosystem validate --organ VI`


## External Mirrors (Network Testament)

- **technical** (3): pallets/click, yaml/pyyaml, sqlalchemy/sqlalchemy

Convergences: 20 | Run: `organvm network map --repo adaptive-personal-syllabus` | `organvm network suggest`
...
**UID:** `ent_repo_01KKKX3RVQEP3HWPGXM3709SK5` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve adaptive-personal-syllabus` | History: `organvm ontologia history ent_repo_01KKKX3RVQEP3HWPGXM3709SK5`
