...
Original source: `GEMINI.md` in [google/dotguides](https://github.com/google/dotguides).
...
```
npx tomevault install google/dotguides
```
Source: [github.com/google/dotguides](https://github.com/google/dotguides).
