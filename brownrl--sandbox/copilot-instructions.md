...
**Example - Explicit Return Types and Method Params:**
```php
...
- Generate code that leverages Laravel's ORM capabilities rather than bypassing them.
...
**Inertia Client Navigation Example:**
```vue
import { Link } from '@inertiajs/vue3'
<Link href="/">Home</Link>
```
...
**Tailwind v4 Import Tailwind Changes:**
```text
REMOVE:
@tailwind base;
@tailwind components;
