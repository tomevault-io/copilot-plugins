...
**Organ:** ORGAN-VI (Community) | **Tier:** flagship | **Status:** GRADUATED
**Org:** `organvm-vi-koinonia` | **Repo:** `community-hub`

### Edges
- **Produces** → `unspecified`: web_application
- **Produces** → `unspecified`: api
- **Consumes** ← `unspecified`: package
- **Consumes** ← `unspecified`: data
- **Consumes** ← `unspecified`: data
...
Run: `organvm ecosystem show community-hub` | `organvm ecosystem validate --organ VI`


## External Mirrors (Network Testament)

- **technical** (4): tiangolo/fastapi, encode/uvicorn, pallets/jinja, sqlalchemy/sqlalchemy

Convergences: 20 | Run: `organvm network map --repo community-hub` | `organvm network suggest`
...
**UID:** `ent_repo_01KKKX3RVQ9P2PD3QQ5MMVWCBA` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve community-hub` | History: `organvm ontologia history ent_repo_01KKKX3RVQ9P2PD3QQ5MMVWCBA`
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/organvm-vi-koinonia) — claim your Tome and manage your conversions.
