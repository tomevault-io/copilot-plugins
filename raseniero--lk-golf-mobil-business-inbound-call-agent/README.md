...
Original source: `.windsurf/rules/*.md` in [raseniero/lk-golf-mobil-business-inbound-call-agent](https://github.com/raseniero/lk-golf-mobil-business-inbound-call-agent).
