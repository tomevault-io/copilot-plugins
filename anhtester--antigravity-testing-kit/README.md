...
Original source: `GEMINI.md` in [anhtester/antigravity-testing-kit](https://github.com/anhtester/antigravity-testing-kit).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/anhtester/antigravity-testing-kit](https://github.com/anhtester/antigravity-testing-kit)
